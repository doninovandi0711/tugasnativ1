package com.doni.myapplication
...
import com.doni.myapplication.MoveWithobjectActivity.Companion.EXTRA_PERSON
    ...
    override fun onClick(p0: View?) {
        when (p0?.id) {
            ...
            R.id.btn_move_activity_object -> {
                val person = Person("Native Moblie Programming", 20, "native@gmail.com", "Pekanbaru")
